...
public class Fruit {
	    ...
	    /**
	     * Slices the fruit by setting its sliced state. If the fruit has not been sliced yet,
	     * it updates the state to indicate that the fruit is now sliced.
	     */
	    public void slice() {
	        if (!isSliced) {
	    ...
	    /**
	     * Checks whether the fruit contains the specified point.
	     * This is for detecting if a user interaction  occurred over the fruit.
	     * 
	     * @param mx is the x-coordinate of the point to check
	     * @param my is the y-coordinate of the point to check
	     * @return true if the specified point is within the fruit's boundaries; false otherwise
	     */
		...
		public void setY(int y) {
		 ...
		 /**
	     * Returns the width of the fruit.
	     * The width is derived from the fruit's image.
	     *
		...
		public float getWidth() {
		  ...
		  /**
	     * Returns the height of the fruit.
	     * The height is derived from the fruit's image.
	     *
